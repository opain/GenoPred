...
# config file
config<-c(
  "outdir: /scratch/prj/oliverpainfel/Software/MyGit/GenoPred/pipeline/misc/dev/test_data/output",
  "config_file: misc/dev/test_data/config/config.yaml",
  "refdir: misc/dev/test_data/ref",
  "resdir: /scratch/prj/oliverpainfel/Software/MyGit/GenoPred/pipeline/misc/dev/test_data/output",
...
mv misc/dev/test_data/output /scratch/prj/oliverpainfel/Software/MyGit/GenoPred/pipeline/misc/dev/test_data/output
```
