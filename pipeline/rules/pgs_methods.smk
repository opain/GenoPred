...
if 'gwas_list' in config:
  rule sumstat_prep_i:
    ...
    shell:
      """
      sumstat_cleaner_script=$(Rscript --vanilla -e 'cat(system.file("scripts", "sumstat_cleaner.R", package = "GenoUtils"))' 2>&1 | grep -Eo "/.*sumstat_cleaner.R")
...
rule ldsc_i:
  ...
  params:
    ...
    testing=config["testing"]
  shell:
    "Rscript --vanilla ../Scripts/ldsc/ldsc.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
...
rule prep_pgs_ptclump_i:
  ...
  shell:
    ...
    Rscript --vanilla ../Scripts/pgs_methods/ptclump.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
...
rule prep_pgs_prscs_i:
  ...
  shell:
    ...
    Rscript --vanilla ../Scripts/pgs_methods/prscs.R \
    --ref_plink_chr {refdir_intersect}/ref.chr \
    --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
...
rule prep_pgs_sbayesr_i:
  ...
  shell:
    ...
    (
      ...
      Rscript --vanilla ../Scripts/pgs_methods/sbayesr.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
...
rule prep_pgs_lassosum_i:
  ...
  shell:
    "Rscript --vanilla ../Scripts/pgs_methods/lassosum.R \
     --ref_plink_chr {refdir_intersect}/ref.chr \
     --ref_keep {refdir}/keep_files/{params.population}.keep \
...
rule prep_pgs_sdpr_i:
  ...
  shell:
    ...
    Rscript --vanilla ../Scripts/pgs_methods/sdpr.R \
         --ref_plink_chr {refdir_intersect}/ref.chr \
         --ref_keep {refdir}/keep_files/{params.population}.keep \
         --gwas_pop {params.population} \
         --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
...
rule prep_pgs_ldpred2_i:
  ...
  shell:
    "export OPENBLAS_NUM_THREADS=1; \
    Rscript --vanilla ../Scripts/pgs_methods/ldpred2.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
...
rule prep_pgs_lassosum2_i:
  ...
  shell:
    "export OPENBLAS_NUM_THREADS=1; \
    Rscript --vanilla ../Scripts/pgs_methods/lassosum2.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --ldpred2_ref_dir {ldpred2_ldref}/{params.population} \
      --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
      --n_cores {threads} \
...
rule prep_pgs_megaprs_i:
  ...
  shell:
    "Rscript --vanilla ../Scripts/pgs_methods/megaprs.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --ref_keep {refdir}/keep_files/{params.population}.keep \
      --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
...
rule prep_pgs_quickprs_i:
  ...
  shell:
    ...
    Rscript --vanilla ../Scripts/pgs_methods/quickprs.R \
    --ref_plink_chr {refdir_intersect}/ref.chr \
    --ref_keep {refdir}/keep_files/{params.population}.keep \
    --sumstats {outdir}/reference/gwas_sumstat/{wildcards.gwas}/{wildcards.gwas}-cleaned.gz \
...
rule prep_pgs_external_i:
  ...
  shell:
    "rm -r -f {outdir}/reference/pgs_score_files/external/{wildcards.score}; \
     Rscript --vanilla ../Scripts/external_score_processor/external_score_processor.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --score {params.score} \
...
rule leopard_quickprs_i:
  ...
  shell:
    ...
    Rscript --vanilla ../Scripts/pgs_methods/leopard_quickprs.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --pop_data {refdir}/ref.pop.txt \
...
checkpoint leopard_reporter:
  ...
  params:
    config_file = config["config_file"]
  shell:
    "Rscript --vanilla ../Scripts/pipeline_misc/leopard_reporter.R {params.config_file} > {log} 2>&1"
...
rule prep_pgs_multi_i:
  ...
  params:
    ...
    config_file = config["config_file"]
  shell:
    "Rscript --vanilla ../Scripts/pgs_methods/apply_leopard_weights.R \
...
rule pgsmeta_i:
  ...
  params:
    ...
    testing=config["testing"]
  shell:
    "Rscript --vanilla ../Scripts/pgs_methods/pgsmeta.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --pop_data {refdir}/ref.pop.txt \
      --sumstats {params.sumstats} \
      --scores {params.scores} \
...
rule prep_pgs_prscsx_i:
  ...
  shell:
    ...
    export OMP_NUM_THREADS=1; \
    export OPENBLAS_NUM_THREADS=1; \
    Rscript --vanilla ../Scripts/pgs_methods/prscsx.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --sumstats {params.sumstats} \
      --populations {params.populations} \
...
rule prep_pgs_xwing_i:
  ...
  shell:
    ...
    export OMP_NUM_THREADS=1; \
    export OPENBLAS_NUM_THREADS=1; \
    Rscript --vanilla ../Scripts/pgs_methods/xwing.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
...
rule prep_pgs_tlprs_i:
  ...
  shell:
    """
    Rscript --vanilla ../Scripts/pgs_methods/tlprs.R \
      --config {params.config_file} \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --sumstats {params.sumstats} \
      --scores {params.scores} \
...
rule prep_pgs_bridgeprs_i:
  ...
  shell:
    """
    Rscript --vanilla ../Scripts/pgs_methods/bridgeprs.R \
      --ref_plink_chr {refdir_intersect}/ref.chr \
      --sumstats {params.sumstats} \
      --populations {params.populations} \
      --pop_data {refdir}/ref.pop.txt \
...
rule ref_pgs:
  ...
  params:
    ...
    config_file = config["config_file"]
  shell:
    "Rscript --vanilla ../Scripts/ref_scoring/ref_scoring.R \
      --config {params.config_file} \
