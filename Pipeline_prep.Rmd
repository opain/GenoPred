...
opt$sumstats<-'/mnt/lustre/groups/ukbiobank/sumstats/munged/EDUC03.sumstats.gz'
...
opt$ref_plink_chr<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/1KGPhase3.w_hm3.chr'
opt$ref_keep<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/keep_files/EUR_samples.keep'
opt$sumstats<-'/mnt/lustre/groups/ukbiobank/sumstats/munged/HEIG03.sumstats.gz'
opt$plink<-'/users/k1806347/brc_scratch/Software/plink1.9.sh'
opt$memory<-3000
opt$dense<-T
opt$output<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/Score_files_for_poylygenic_dense/HEIG03/1KGPhase3.w_hm3.HEIG03'
opt$ref_pop_scale<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/super_pop_keep.list'
opt$prsice_path<-'/users/k1806347/brc_scratch/Software/PRSice'
opt$rscript<-'/users/k1806347/brc_scratch/Software/Rscript.sh'
...
for(i in 3:3){
  ...
  if(length(files) == nsnp_chunk){
    ...
    system(paste0('qsub -b y -q LowMemShortterm.q@nodec01,LowMemShortterm.q@nodec10,LowMemShortterm.q@nodec05,LowMemShortterm.q@nodec16,LowMemShortterm.q@nodec06 -l h_vmem=',round(2.1*nsnp_chunk),'G ',gctb,' --mldm ',Geno_1KG_dir,'/LD_matrix/EUR/shrunk_ld_chr',i,'merge_list --make-shrunk-ldm --out ',Geno_1KG_dir,'/LD_matrix/EUR/1KGPhase3.w_hm3.EUR.chr',i))
  } else {
