...
LD matrices based on EUR UKBB individuals derived by GCTB authors have shared. Download them for comparison.
...
opt$ref_keep<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/keep_files/EUR_samples.keep'
opt$sumstats<-'/scratch/groups/ukbiobank/sumstats/cleaned/RHEU01.gz'
opt$plink<-'/users/k1806347/brc_scratch/Software/plink1.9/plink'
opt$gctb<-'/users/k1806347/brc_scratch/Software/gctb_2.0_Linux/gctb.sh'
opt$ld_matrix_chr<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/LD_matrix/EUR/1KGPhase3.w_hm3.EUR.chr'
opt$memory<-10000
opt$n_cores<-1
opt$munged<-F
opt$output<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/Score_files_for_poylygenic_SBayesR/RHEU01_Test/1KGPhase3.w_hm3.RHEU01'
opt$ref_pop_scale<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/super_pop_keep.list'
opt$auto_trunc<-F
opt$impute_N<-T
