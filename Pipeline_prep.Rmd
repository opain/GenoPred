...
# Too many variants are being removed from the BODY03, BODY11 and SCLE02 GWAS.
...
opt$ref_keep<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/keep_files/EUR_samples.keep'
opt$sumstats<-'/scratch/groups/ukbiobank/sumstats/munged/BODY11.sumstats.gz'
...
opt$memory<-30000
opt$n_cores<-1
opt$output<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/Score_files_for_poylygenic_SBayesR/BODY11_Test/1KGPhase3.w_hm3.BODY11'
opt$ref_pop_scale<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/super_pop_keep.list'
...
# Run script for selected GWAS
for gwas in $(cat ${Geno_1KG_dir}/Score_files_for_poylygenic_LDPred/todo.txt | head -n 1);do
