...
opt$ref_keep<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/keep_files/EUR_samples.keep'
opt$sumstats<-'/scratch/groups/ukbiobank/sumstats/munged/BODY03.sumstats.gz'
...
opt$n_cores<-1
opt$munged<-T
opt$output<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/Score_files_for_poylygenic_SBayesR/BODY03_Test/1KGPhase3.w_hm3.BODY03'
opt$ref_pop_scale<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/super_pop_keep.list'
opt$auto_trunc<-T
