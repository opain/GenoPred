...
# Download and preprare required reference genetic data
## Download the IMPUTE2 1000 Genomes Phase 3 data 
...
## Download the LD-score regression list of HapMap3 SNPs
<details><summary>Show code</summary>
```{bash, eval=F, echo=T}
...
## Create a keep file listing each population in the reference and file listing unique populations
<details><summary>Show code</summary>
```{bash, eval=F, echo=T}
...
## Calculate allele frequency files for each population in the reference and across individuals
<details><summary>Show code</summary>
```{bash, eval=F, echo=T}
