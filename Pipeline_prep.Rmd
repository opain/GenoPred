...
First we need to create a specially formatted LD matrix for SBayesR.
...
opt$ld_matrix<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/LD_matrix/EUR/1KGPhase3.w_hm3.EUR.sparse.ldm.list'
opt$memory<-8000
opt$n_cores<-1
opt$output<-'/users/k1806347/brc_scratch/Data/1KG/Phase3/Score_files_for_poylygenic_SBayesR/DIAB05/1KGPhase3.w_hm3.DIAB05'
