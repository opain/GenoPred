...
write.csv(All_res, '/mnt/lustre/users/k1806347/Analyses/TEDS_outcomes_for_prediction/PRS_method_comp.csv', row.names=F)
...
png('/mnt/lustre/users/k1806347/Analyses/TEDS_outcomes_for_prediction/PRS_method_comp_CrossVal_TEDS.png', units='px', res=300, width=3000, height=3000)
plot_grid(plotlist=plots, ncol = 2)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/TEDS_outcomes_for_prediction/PRS_method_comp_IndepVal_TEDS.png', units='px', res=300, width=3000, height=3000)
plot_grid(plotlist=plots, ncol = 2)
dev.off()
...
![Figure 1: Predictive utility estimated using 10-fold cross-validation](/users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Determine_optimal_polygenic_scoring_approach/PRS_method_comp_CrossVal_TEDS.png)

<br/>

***

![Figure 2: Predictive utility estimated using test set validation](/users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Determine_optimal_polygenic_scoring_approach/PRS_method_comp_IndepVal_TEDS.png)
...
res<-read.csv("/users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/PRS_method_comp.csv")
