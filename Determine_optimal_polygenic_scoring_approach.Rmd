...
for(i in c(1:4)){
  ...
  pT_clump_nn$Method<-"pT + clump\n(sparse, non-nested)"
  Param_tmp<-sort(as.numeric(gsub('e.','e-',gsub('_group','',gsub(paste0(gwas[i],'.'),'',pT_clump_nn$Model)))))
  ...
  pT_clump_nn<-pT_clump_nn[match(c(Param_tmp,'Multi-PRS'), pT_clump_nn$Param),]
