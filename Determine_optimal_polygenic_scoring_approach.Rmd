...
## Code
<details><summary>pT + clump PRSs</summary>
```{bash, echo=T, eval=F}
##############################
...
for i in $(seq 1 4);do
  ...
  qsub -l h_vmem=3G -pe smp 5 /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/Scripts/Model_builder.R \
...
```{r pressure, echo=FALSE, fig.cap="Figure 1: Predictive utility estimated using 10-fold cross-validation", out.width = '100%'}
knitr::include_graphics("/users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Determine_optimal_polygenic_scoring_approach/PRS_method_comp_CrossVal.png")
```
