...
# NOTE: If there is no 10FC bar for lassosum, it is because the best threshold was the threshold selected by psuedovalidation.
...
png('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_CrossVal_UKBB.UKBB_ref.png', units='px', res=300, width=3000, height=5000)
plot_grid(plotlist=plots, ncol = 2)
dev.off()
...
png('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_IndepVal_UKBB.UKBB_ref.png', units='px', res=300, width=3000, height=5000)
plot_grid(plotlist=plots, ncol = 2)
dev.off()
