...
for i in $(seq 1 9);do
  ...
  sbatch -n 1 --mem 10G -p brc,shared -J PRScs /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Scaled_polygenic_scorer_PRScs/Scaled_polygenic_scorer_PRScs.R \
    --target_plink_chr ${UKBB_output}/Genotype/Harmonised/UKBB.w_hm3.QCd.AllSNP.chr \
    --target_keep ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
    --ref_score ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_PRScs/${gwas_i}/UKBB.noPheno.EUR.10K.w_hm3.${gwas_i} \
    --ref_scale ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_PRScs/${gwas_i}/UKBB.noPheno.EUR.10K.w_hm3.${gwas_i}.EUR.scale \
    --ref_freq_chr ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.chr \
    --plink ${plink1_9} \
    --pheno_name ${gwas_i} \
    --output ${UKBB_output}/PRS_for_comparison/UKBB_ref/PRScs/${gwas_i}/UKBB.subset.w_hm3.${gwas_i}
done
```
</details>
...
# Calculate polygenic scores usng the GCTB-provided LD reference with unmunged sumstats
for i in $(seq 1 9);do
  pheno_i=$(echo ${pheno} | cut -f ${i} -d ' ')
  gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
  ...
  sbatch -n 1 --mem 10G -p brc,shared -J SBayesR /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Scaled_polygenic_scorer_SBayesR/Scaled_polygenic_scorer_SBayesR.R \
    --target_plink_chr ${UKBB_output}/Genotype/Harmonised/UKBB.w_hm3.QCd.AllSNP.chr \
    --target_keep ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
    --ref_score ${Geno_1KG_dir}/Score_files_for_poylygenic_SBayesR/${gwas_i}_GCTBref_unmunged/GWAS_sumstats_SBayesR.GW.snpRes \
    --ref_scale ${Geno_1KG_dir}/Score_files_for_poylygenic_SBayesR/${gwas_i}_GCTBref_unmunged/1KGPhase3.w_hm3.${gwas_i}.EUR.scale \
    --ref_freq_chr ${Geno_1KG_dir}/freq_files/EUR/1KGPhase3.w_hm3.EUR.chr \
    --plink ${plink1_9} \
    --pheno_name ${gwas_i} \
    --output ${UKBB_output}/PRS_for_comparison/1KG_ref/SBayesR/${gwas_i}_GCTBref_unmunged/UKBB.subset.w_hm3.${gwas_i}
done
...
sbatch -n 1 --mem 10G -p brc,shared -J PRScs /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Scaled_polygenic_scorer_PRScs/Scaled_polygenic_scorer_PRScs.R \
  --target_plink_chr ${TEDS_output_dir}/Genotype/Harmonised/TEDS.w_hm3.QCd.AllSNP.chr \
	--target_keep ${TEDS_output_dir}/Projected_PCs/Ancestry_idenitfier/TEDS.w_hm3.AllAncestry.EUR.keep \
  --ref_score ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_PRScs/${gwas}/UKBB.noPheno.EUR.10K.w_hm3.${gwas} \
  --ref_scale ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_PRScs/${gwas}/UKBB.noPheno.EUR.10K.w_hm3.${gwas}.EUR.scale \
  --ref_freq_chr ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.chr \
  --plink ${plink1_9} \
  --pheno_name ${gwas} \
  --output ${TEDS_output_dir}/UKBB_ref/PolygenicScores_PRScs/EUR/${gwas}/TEDS.w_hm3.${gwas}.EUR
done
...
sbatch -n 1 --mem 10G -p brc,shared -J SBayesR /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Scaled_polygenic_scorer_SBayesR/Scaled_polygenic_scorer_SBayesR.R \
  --target_plink_chr ${TEDS_output_dir}/Genotype/Harmonised/TEDS.w_hm3.QCd.AllSNP.chr \
	--target_keep ${TEDS_output_dir}/Projected_PCs/Ancestry_idenitfier/TEDS.w_hm3.AllAncestry.EUR.keep \
  --ref_score ${Geno_1KG_dir}/Score_files_for_poylygenic_SBayesR/${gwas}_GCTBref_unmunged/GWAS_sumstats_SBayesR.GW.snpRes \
  --ref_scale ${Geno_1KG_dir}/Score_files_for_poylygenic_SBayesR/${gwas}_GCTBref_unmunged/1KGPhase3.w_hm3.${gwas}.EUR.scale \
  --ref_freq_chr ${Geno_1KG_dir}/freq_files/EUR/1KGPhase3.w_hm3.EUR.chr \
  --plink ${plink1_9} \
  --pheno_name ${gwas} \
  --output ${TEDS_output_dir}/PolygenicScores_SBayesR/EUR/${gwas}_GCTBref_unmunged/TEDS.w_hm3.${gwas}.EUR
done
...
sbatch --mem 10G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript_for_lassosum.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
...
sbatch --mem 10G -n 4 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript_for_lassosum.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
  --pheno ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
  --keep /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
...
cat > /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs.predictor_groups <<EOF
predictors 
${UKBB_output}/PRS_for_comparison/UKBB_ref/PRScs/${gwas_i}/UKBB.subset.w_hm3.${gwas_i}.PRScs_profiles
EOF
...
sbatch --mem 5G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript_for_lassosum.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
  --pheno ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
  --keep /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
...
sbatch --mem 5G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript_for_lassosum.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
  --pheno ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
  --keep /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
  --out /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs \
  --n_core 1 \
  --compare_predictors T \
  --assoc T \
  --outcome_pop_prev ${prev_i} \
  --predictors /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs.predictor_groups
done
```
</details>
...
cat > /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR.predictor_groups <<EOF
predictors 
${UKBB_output}/PRS_for_comparison/1KG_ref/SBayesR/${gwas_i}_GCTBref_unmunged/UKBB.subset.w_hm3.${gwas_i}.SBayesR_profiles
EOF
...
sbatch --mem 10G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript_for_lassosum.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
  --pheno /users/k1806347/brc_scratch/Data/UKBB/Phenotype/${pheno_i}/${pheno_file_i} \
  --keep /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
  --out /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR \
  --n_core 2 \
  --compare_predictors T \
  --assoc T \
  --outcome_pop_prev ${prev_i} \
  --predictors /users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/${pheno_i}/Association_withPRSs/UKBB.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR.predictor_groups
done
...
cat > /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs.predictor_groups <<EOF
predictors 
/users/k1806347/brc_scratch/Data/TEDS/UKBB_ref/PolygenicScores_PRScs/EUR/${gwas_i}/TEDS.w_hm3.${gwas_i}.EUR.PRScs_profiles
EOF
...
--pheno /users/k1806347/brc_scratch/Data/TEDS/Phenotypic/Derived_outcomes/TEDS_${pheno_i}.txt \
--keep /users/k1806347/brc_scratch/Data/TEDS/Projected_PCs/Ancestry_idenitfier/TEDS.w_hm3.AllAncestry.EUR.keep \
--out /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs \
--n_core 2 \
--compare_predictors T \
--assoc T \
--outcome_pop_prev ${prev_i} \
--predictors /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.UKBB_ref.${gwas_i}.EUR-PRSs_PRScs.predictor_groups
done
...
cat > /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR.predictor_groups <<EOF
predictors 
/users/k1806347/brc_scratch/Data/TEDS/PolygenicScores_SBayesR/EUR/${gwas_i}_GCTBref_unmunged/TEDS.w_hm3.${gwas_i}.EUR.SBayesR_profiles
EOF
...
--pheno /users/k1806347/brc_scratch/Data/TEDS/Phenotypic/Derived_outcomes/TEDS_${pheno_i}.txt \
--keep /users/k1806347/brc_scratch/Data/TEDS/Projected_PCs/Ancestry_idenitfier/TEDS.w_hm3.AllAncestry.EUR.keep \
--out /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR \
--n_core 2 \
--compare_predictors T \
--assoc T \
--outcome_pop_prev ${prev_i} \
--predictors /users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.${gwas_i}_GCTBref_unmunged-PRSs_SBayesR.predictor_groups
done
...
## Using GCTB-provided LD reference and unmunged sumstats
Here we will tabulate the SBayesR analysis when using the GCTB-provided LD reference and unmunged sumstats, and create a plot comparing the results across the LD references used.
...
#####
# TEDS with GCTB_ref_unmunged
#####
# Read in the results, labelling which parameters where pseudovalidated and validated using 10-fold cross validation
All_res<-NULL
for(i in c(1:4)){

  if(file.exists(paste0('/users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'_GCTBref_unmunged-PRSs_SBayesR.pred_eval.txt'))){
      SBayesR_res<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'_GCTBref_unmunged-PRSs_SBayesR.pred_eval.txt'), header=T, stringsAsFactors=F)
  SBayesR_res$Method<-'SBayesR'
  SBayesR_res$Param<-gsub('_group','',gsub(paste0(gwas[i],'.'),'',SBayesR_res$Model))
  SBayesR_res$Model<-NULL
  SBayesR_res$Group<-NA
...
write.csv(All_res_tab, '/scratch/users/k1806347/Analyses/TEDS_outcomes_for_prediction/PRS_SBayesR_unmunged_TEDS.csv', row.names=F)
rm(All_res)
...
All_res<-NULL
for(i in c(1:9)){
  if(file.exists(paste0('/users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/UKBB.w_hm3.',gwas[i],'_GCTBref_unmunged-PRSs_SBayesR.pred_eval.txt'))){
    SBayesR_res<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/UKBB.w_hm3.',gwas[i],'_GCTBref_unmunged-PRSs_SBayesR.pred_eval.txt'), header=T, stringsAsFactors=F)
    SBayesR_res$Method<-'SBayesR'
    SBayesR_res$Param<-gsub('_group','',gsub(paste0(gwas[i],'.'),'',SBayesR_res$Model))
    SBayesR_res$Model<-NULL
    SBayesR_res$Group<-NA
...
write.csv(All_res, '/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_SBayesR_unmunged_UKBB.csv', row.names=F)
...
res_GCTBref_unmunged_UKBB<-fread(paste0('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_SBayesR_unmunged_UKBB.csv'))
res_GCTBref_unmunged_UKBB$Ref<-'GCTB_unmunged'

res_UKBB<-do.call(rbind, list(res_1KGref_UKBB, res_UKBref_UKBB, res_GCTBref_UKBB, res_GCTBref_unmunged_UKBB))
res_UKBB<-res_UKBB[res_UKBB$Method == 'SBayesR',]

res_UKBB$Test<-paste0(res_UKBB$Method, ':', res_UKBB$Group, ':', res_UKBB$Ref)
res_UKBB$Ref<-factor(res_UKBB$Ref, level=c('1KG','UKB','GCTB','GCTB_unmunged'))
...
res_GCTBref_unmunged_TEDS<-fread(paste0('/scratch/users/k1806347/Analyses/TEDS_outcomes_for_prediction/PRS_SBayesR_unmunged_TEDS.csv'))
res_GCTBref_unmunged_TEDS$Ref<-'GCTB_unmunged'

res_TEDS<-do.call(rbind, list(res_1KGref_TEDS, res_UKBref_TEDS, res_GCTBref_TEDS, res_GCTBref_unmunged_TEDS))
res_TEDS<-res_TEDS[res_TEDS$Method == 'SBayesR',]

res_TEDS$Test<-paste0(res_TEDS$Method, ':', res_TEDS$Group, ':', res_TEDS$Ref)
res_TEDS$Ref<-factor(res_TEDS$Ref, level=c('1KG','UKB','GCTB','GCTB_unmunged'))
...
```{bash, eval=T, echo=F}
cp /scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_SBayesR_LDref_comp_Average_CrossVal.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Determine_optimal_polygenic_scoring_approach/

cp /scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_SBayesR_LDref_comp_Average_IndepVal.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Determine_optimal_polygenic_scoring_approach/
...
for(file in 1:length(Files)){
  ...
  for(i in unique(res$Test)){
    ...
    res_pT_10FC<-res[res$Test == 'pT:10FCVal',]
    
    res_i_diff<-res_i
    res_i_diff$CrossVal_R<-res_i$CrossVal_R-res_pT_10FC$CrossVal_R
    res_i_diff$IndepVal_R<-res_i$IndepVal_R-res_pT_10FC$IndepVal_R
      
    res_aver_i<-data.frame(Test=i,
                          Method=res_i$Method[1],
                          Group=res_i$Group[1],
                          Mean_R_CrossVal=mean(res_i$CrossVal_R),
                          min_R_CrossVal=min(res_i$CrossVal_R),
                          max_R_CrossVal=max(res_i$CrossVal_R),
                          Mean_R_IndepVal=mean(res_i$IndepVal_R),
                          min_R_IndepVal=min(res_i$IndepVal_R),
                          max_R_IndepVal=max(res_i$IndepVal_R),

                          Mean_R_diff_CrossVal=mean(res_i_diff$CrossVal_R),
                          min_R_diff_CrossVal=min(res_i_diff$CrossVal_R),
                          max_R_diff_CrossVal=max(res_i_diff$CrossVal_R),
                          Mean_R_diff_IndepVal=mean(res_i_diff$IndepVal_R),
                          min_R_diff_IndepVal=min(res_i_diff$IndepVal_R),
                          max_R_diff_IndepVal=max(res_i_diff$IndepVal_R))
    res_aver<-rbind(res_aver, res_aver_i)
    
  }
  
      Plots_CrossVal[[Files[file]]] <- ggplot( res_aver, aes(x=Method, y=Mean_R_CrossVal, fill=Group)) +
                        geom_bar(stat="identity", position=position_dodge(preserve = "single"), width = 0.7, colour='black') +
                        geom_errorbar(aes(ymin=min_R_CrossVal, ymax=max_R_CrossVal), width=.4, position=position_dodge(width = 0.7, preserve = "single")) +
                        labs(y="Mean Correlation\n(min and max)", x='', title=Files_descrip[file]) +
                        theme(axis.text.x = element_text(angle = 45, hjust = 1))
  
      Plots_IndepVal[[Files[file]]] <- ggplot( res_aver, aes(x=Method, y=Mean_R_IndepVal, fill=Group)) +
                        geom_bar(stat="identity", position=position_dodge(preserve = "single"), width = 0.7, colour='black') +
                        geom_errorbar(aes(ymin=min_R_IndepVal, ymax=max_R_IndepVal), width=.4, position=position_dodge(width = 0.7, preserve = "single")) +
                        labs(y="Mean Correlation\n(min and max)", x='', title=Files_descrip[file]) +
              				  theme(axis.text.x = element_text(angle = 45, hjust = 1))
  
      Plots_CrossVal_diff[[Files[file]]] <- ggplot( res_aver, aes(x=Method, y=Mean_R_diff_CrossVal, fill=Group)) +
                        geom_bar(stat="identity", position=position_dodge(preserve = "single"), width = 0.7, colour='black') +
                        geom_errorbar(aes(ymin=min_R_diff_CrossVal, ymax=max_R_diff_CrossVal), width=.4, position=position_dodge(width = 0.7, preserve = "single")) +
                        labs(y="Mean difference\n(min and max)", x='', title=Files_descrip[file]) +
                        geom_hline(yintercept=0) +
                        theme(axis.text.x = element_text(angle = 45, hjust = 1))
  
      Plots_IndepVal_diff[[Files[file]]] <- ggplot( res_aver, aes(x=Method, y=Mean_R_diff_IndepVal, fill=Group)) +
                        geom_bar(stat="identity", position=position_dodge(preserve = "single"), width = 0.7, colour='black') +
                        geom_errorbar(aes(ymin=min_R_diff_IndepVal, ymax=max_R_diff_IndepVal), width=.4, position=position_dodge(width = 0.7, preserve = "single")) +
                        labs(y="Mean difference\n(min and max)", x='', title=Files_descrip[file]) +
                        geom_hline(yintercept=0) +
              				  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
bitmap('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_Average_CrossVal.png', units='px', res=300, width=3000, height=2000)
plot_grid(plotlist=Plots_CrossVal, ncol = 2)
dev.off()

bitmap('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_Average_IndepVal.png', units='px', res=300, width=3000, height=2000)
plot_grid(plotlist=Plots_IndepVal, ncol = 2)
dev.off()

bitmap('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_Average_diff_CrossVal.png', units='px', res=300, width=3000, height=2000)
plot_grid(plotlist=Plots_CrossVal_diff, ncol = 2)
dev.off()

bitmap('/scratch/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_Average_diff_IndepVal.png', units='px', res=300, width=3000, height=2000)
...
<details><summary>Show average cross-validation results</summary>
...
<details><summary>Show average test-validation results</summary>
...
<details><summary>Show average difference cross-validation results</summary>
...
<details><summary>Show average difference test-validation results</summary>
