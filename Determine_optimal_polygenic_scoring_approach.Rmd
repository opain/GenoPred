...
```{bash, eval=T, echo=F, results = 'hide'}
mkdir /users/k1806347/brc_scratch/Software/MyGit/GenoPred/docs/Images/Determine_optimal_polygenic_scoring_approach

cp /mnt/lustre/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_CrossVal.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/docs/Images/Determine_optimal_polygenic_scoring_approach/

cp /mnt/lustre/users/k1806347/Analyses/UKBB_outcomes_for_prediction/PRS_method_comp_IndepVal.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/docs/Images/Determine_optimal_polygenic_scoring_approach/
```

<center>

![<b>Figure 1: Predictive utility estimated using 10-fold cross-validation \b>](/users/k1806347/brc_scratch/Software/MyGit/GenoPred/docs/Images/Determine_optimal_polygenic_scoring_approach/PRS_method_comp_CrossVal.png)

***

![<b>Figure 2: Predictive utility estimated using test set validation \b>](/users/k1806347/brc_scratch/Software/MyGit/GenoPred/docs/Images/Determine_optimal_polygenic_scoring_approach/PRS_method_comp_IndepVal.png)
...
- [ ] Make results table nicer

- [ ] Write discussion

- [ ] Integrate other analyses
