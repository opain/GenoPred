...
<center>
![<b>Figure 1: Predictive utility estimated using 10-fold cross-validation \b>](C:/Users\ollie\OneDrive - King's College London\KCL_postdoc\Scripts\Evaluating genetic predictors in UKBB\Derive and evaluate models\PRS_method_comp_CrossVal.png)

***

![<b>Figure 2: Predictive utility estimated using test set validation \b>](C:/Users\ollie\OneDrive - King's College London\KCL_postdoc\Scripts\Evaluating genetic predictors in UKBB\Derive and evaluate models\PRS_method_comp_IndepVal.png)
...
res<-read.csv("C:/Users/ollie/OneDrive - King's College London/KCL_postdoc/Scripts/Evaluating genetic predictors in UKBB/Derive and evaluate models/PRS_method_comp.csv")
