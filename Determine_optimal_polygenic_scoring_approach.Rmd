...
for(file in 1:length(Files)){
  ...
  for(i in 1:length(pheno)){
    ...
    res_eval_diff_matrix_cross[[pheno[i]]]<-ggplot(data = res_comp_i_select, aes(Model_1_Test, Model_2_Test, fill=Cross_R_diff_catagory))+
     ...
     theme(axis.text.x = element_text(angle = 45, vjust = 1, 
        size = 8, hjust = 1))+
     coord_fixed() +
    geom_text(data=res_comp_i_select, aes(Model_1_Test, Model_2_Test, label = cross_star), color = "black", size = 4, angle = 90, vjust=0.8) +
    ...
    res_eval_diff_matrix_indep[[pheno[i]]]<-ggplot(data = res_comp_i_select, aes(Model_1_Test, Model_2_Test, fill=Indep_R_diff_catagory))+
     ...
     theme(axis.text.x = element_text(angle = 45, vjust = 1, 
        size = 8, hjust = 1))+
     coord_fixed() +
    geom_text(data=res_comp_i_select, aes(Model_1_Test, Model_2_Test, label = indep_star), color = "black", size = 4, angle = 90, vjust=0.8) +
    scale_fill_brewer(palette = "RdBu", drop=F)
  }
  ...
  meta_res_eval_diff_matrix_cross[[Files[file]]]<-ggplot(data = meta_res_diff, aes(Test_ref, Test_targ, fill=Cross_R_diff_catagory))+
   ...
   theme(axis.text.x = element_text(angle = 45, vjust = 1, 
      size = 8, hjust = 1)) +
   coord_fixed() +
  geom_text(data=meta_res_diff, aes(Test_ref, Test_targ, label = cross_star), color = "black", size = 4, angle = 90, vjust=0.8) +
  scale_fill_brewer(palette = "RdBu", drop=F)
  ...
  meta_res_eval_diff_matrix_indep[[Files[file]]]<-ggplot(data = meta_res_diff, aes(Test_ref, Test_targ, fill=Indep_R_diff_catagory))+
   ...
   theme(axis.text.x = element_text(angle = 45, vjust = 1, 
      size = 8, hjust = 1))+
   coord_fixed() +
  geom_text(data=meta_res_diff, aes(Test_ref, Test_targ, label = indep_star), color = "black", size = 4, angle = 90, vjust=0.8) +
  scale_fill_brewer(palette = "RdBu", drop=F)
