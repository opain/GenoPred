...
imputation_log<-readLines(paste0('resources/data/target/',params$name,'/',params$name,'.23andMe_imputer.log'))
...
model_pred<-fread(paste0('resources/data/target/',params$name,'/ancestry_',pred_super_pop,'/',params$name,'.Ancestry.model_pred'))
...
```{r, echo=FALSE, fig.cap="Principal Component Scores Compared to Reference Super Populations", out.width = '100%'}
knitr::include_graphics(normalizePath(paste0('resources/data/target/',params$name,'/ancestry_',pred_super_pop,'/', params$name,'.Ancestry.PCs_plot_pop.png')))
```
...
for(gwas_i in gwas_list$name){
  prs_i<-fread(paste0('resources/data/target/',params$name,'/prs/',pred_super_pop,'/dbslmm/',gwas_i,'/',params$name,'.',gwas_i,'.',pred_super_pop,'.DBSLMM_profiles'))
...
source('resources/scripts/absolute_scale_conversions.R')
