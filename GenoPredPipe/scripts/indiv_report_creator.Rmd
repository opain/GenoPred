...
model_pred<-fread(paste0('resources/data/target/',params$name,'/ancestry/ancestry_',pred_super_pop,'/',params$name,'.Ancestry.model_pred'))
...
```{r, echo=FALSE, fig.cap="Principal Component Scores Compared to Reference Super Populations", out.width = '100%'}
knitr::include_graphics(normalizePath(paste0('resources/data/target/',params$name,'/ancestry/ancestry_',pred_super_pop,'/', params$name,'.Ancestry.PCs_plot_pop.png')))
```
