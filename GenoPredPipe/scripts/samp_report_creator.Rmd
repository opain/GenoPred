...
model_pred<-fread(paste0('resources/data/target/',params$name,'/ancestry/ancestry_all/',params$name,'.Ancestry.model_pred'))
...
knitr::include_graphics(normalizePath(paste0('resources/data/target/',params$name,'/ancestry/ancestry_all/', params$name,'.Ancestry.PCs_plot_super_pop.png')))
```
...
for(population in unique(model_pred_hard$Population)){
  ...
  model_pred<-fread(paste0('resources/data/target/',params$name,'/ancestry/ancestry_',population,'/',params$name,'.Ancestry.model_pred'))
  probs_melt<-melt(model_pred[,-1:-2])
