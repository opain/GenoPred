...
pgs_method_labels <- data.frame(
  method = c('ptclump','dbslmm','ldpred2','sbayesr','sbayesrc','lassosum','prscs','megaprs','quickprs','external','prscsx','xwing','ptclump_multi','dbslmm_multi','ldpred2_multi','sbayesr_multi','sbayesrc_multi','lassosum_multi','prscs_multi','megaprs_multi','quickprs_multi','tlprs_dbslmm'),
  label = c('pT+clump','DBSLMM','LDpred2','SBayesR','SBayesRC','lassosum','PRS-CS','MegaPRS','QuickPRS','External','PRS-CSx','X-Wing','pT+clump-multi','DBSLMM-multi','LDpred2-multi','SBayesR-multi','SBayesRC-multi','lassosum-multi','PRS-CS-multi','MegaPRS-multi','QuickPRS-multi','TL-DBSLMM')
)
