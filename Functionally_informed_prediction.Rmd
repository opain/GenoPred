...
sbatch --mem 10G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder.R \
    --pheno ${TEDS_output_dir}/Phenotypic/Derived_outcomes/TEDS_${pheno_i}.txt \
	  --keep /users/k1806347/brc_scratch/Data/TEDS/Projected_PCs/Ancestry_idenitfier/TEDS.w_hm3.AllAncestry.EUR.keep \
    --out /users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/${pheno_i}/Association_withPRSs/TEDS.w_hm3.${gwas_i}.EUR-PRSs-TWAS_gene_stratifievd \
    --n_core 2 \
    --compare_predictors F \
    --assoc T \
    --outcome_pop_prev ${prev_i} \
...
All_res_plot$Model[!All_res_plot$Model == 'Full_model' & All_res_plot$Test == 'GeRS_multi_tissue']<-'GeRS TissueSpecific Best Tissue   '
All_res_plot$Model[All_res_plot$Model == 'Full_model' & All_res_plot$Test == 'GeRS_multi_tissue']<-'GeRS TissueSpecific Multi Tissue'

All_res_plot$Model[!All_res_plot$Model == 'Full_model' & All_res_plot$Test == 'PRS_and_GeRS']<-'PRS only   '
All_res_plot$Model[All_res_plot$Model == 'Full_model' & All_res_plot$Test == 'PRS_and_GeRS']<-'PRS + GeRS TissueSpecific'
...
res_diff$Prop_GE<-res_diff$vg_est_GeRS/res_diff$vg_est_PRS

res_diff[,-1:-2]<-round(res_diff[,-1:-2],3)
...
res_4<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'.EUR-PRSs-TWAS_gene_stratifievd.pred_comp.txt'), header=T, stringsAsFactors=F)
...
res_stratPRS<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'.EUR-PRSs-TWAS_gene_stratifievd.pred_eval.txt'), header=T, stringsAsFactors=F)
