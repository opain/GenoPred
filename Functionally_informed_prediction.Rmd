...
![Predictive utility](Images/Functionally_informed_prediction/GeRS_per_pT_UKBB.png)
...
```{r, echo=F, eval=T, results='asis', message = F, warning=F}
...
library(knitr)
kable(res_diff, rownames = FALSE, caption='cis-regulated expression-based heritability in UKBB')
...
![Predictive utility](Images/Functionally_informed_prediction/GeRS_per_pT_TEDS.png)
...
res_plot<-do.call(rbind, list(res_PRS, res_GeRS, res_GeRS_coloc))
res_plot$Phenotype<-factor(res_plot$Phenotype, levels=c('Height21', 'BMI21', 'GCSE', 'ADHD'))
