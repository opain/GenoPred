...
cat > /users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/UKBB.w_hm3.${weights}.${gwas_i}.EUR-GeRSs.predictor_groups <<EOF
predictors 
...
sbatch --mem 10G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder_V2.R \
    ...
    --out /users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/UKBB.w_hm3.${weights}.${gwas_i}.EUR-GeRSs \
    --n_core 2 \
    --compare_predictors T \
    --assoc T \
    --outcome_pop_prev ${prev_i} \
    --predictors /users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/UKBB.w_hm3.${weights}.${gwas_i}.EUR-GeRSs.predictor_groups
done
...
sbatch --mem 20G -n 4 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder_V2.R \
    --pheno ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
    --keep /users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
...
sbatch --mem 10G -n 4 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder_V2.R \
    --pheno ${UKBB_output}/Phenotype/PRS_comp_subset/UKBB.${pheno_i}.txt \
    --keep /users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/ukb18177_glanville_post_qc_id_list.UpdateIDs.fam \
...
cat > /users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/TEDS.w_hm3.${weights}.${gwas_i}.EUR-GeRSs.predictor_groups <<EOF
predictors 
...
sbatch --mem 10G -n 2 -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/Model_builder/Model_builder_V2.R \
    ...
    --out /users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/TEDS.w_hm3.${weights}.${gwas_i}.EUR-GeRSs \
    --n_core 2 \
    --compare_predictors T \
    --assoc T \
    --outcome_pop_prev ${prev_i} \
    --predictors /users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/${pheno_i}/Association_withGeRSs/TEDS.w_hm3.${weights}.${gwas_i}.EUR-GeRSs.predictor_groups
done
...
for(i in 1:8){
  ...
  res_i$Indep_Z<-res_i$IndepVal_R/res_i$IndepVal_R_SE
  
  GeRS_res[[gwas[i]]]<-res_i
  
  log_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/UKBB.w_hm3.AllTissue.',gwas[i],'.EUR-GeRSs.per_PT.log'), header=F, stringsAsFactors=F, sep='&')
...
for(i in 1:8){
  if(is.na(prev[i])){
    N_line<-logs[[gwas[i]]]$V1[grepl('Test data contains',logs[[gwas[i]]]$V1)]
  targ_N<-as.numeric(gsub(' individuals.','',gsub('Test data contains ','',N_line)))
    ...
    N_line<-logs[[gwas[i]]]$V1[grepl('Test data contains',logs[[gwas[i]]]$V1)]
    targ_N<-as.numeric(gsub(' individuals.*','',gsub('Test data contains ','',N_line)))
    targ_N_Ca<-as.numeric(gsub(' .*','',gsub(".*\\(",'',N_line)))
    targ_N_Co<-as.numeric(gsub(' .*','',gsub(".* and ",'',N_line)))
...
logs<-list()
for(i in 1:8){
  res_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/UKBB.w_hm3.',gwas[i],'.EUR-PRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
  ...
  log_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/UKBB.w_hm3.',gwas[i],'.EUR-PRSs.log'), header=F, stringsAsFactors=F, sep='&')
...
for(i in 1:4){
  ...
  log_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/TEDS.w_hm3.AllTissue.',gwas[i],'.EUR-GeRSs.per_PT.log'), header=F, stringsAsFactors=F, sep='&')
...
logs<-list()
for(i in 1:4){
  res_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'.EUR-PRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
  ...
  log_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'.EUR-PRSs.log'), header=F, stringsAsFactors=F, sep='&')
...
res_best<-NULL
for(i in 1:8){
  res_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/UKBB.w_hm3.',weight,'.',gwas[i],'.EUR-GeRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
  
  res_i$Phenotype<-pheno[i]
  res_i<-res_i[,c('Phenotype','Model','CrossVal_R','CrossVal_R_SE','CrossVal_pval','IndepVal_R','IndepVal_R_SE','IndepVal_pval')]
  res_i$Model<-gsub('_group','',gsub(paste0(gwas[i],'.'),'',res_i$Model))
  res_i$Model<-factor(res_i$Model, levels=res_i$Model)
  
  res_i_best<-res_i[res_i$CrossVal_R == max(res_i$CrossVal_R),]

  res<-rbind(res, res_i)
  res_best<-rbind(res_best, res_i_best)
}

res<-res[,c('Phenotype','Model','CrossVal_R','CrossVal_R_SE','IndepVal_R','IndepVal_R_SE')]
res_best<-res_best[,c('Phenotype','Model','IndepVal_R','IndepVal_R_SE','IndepVal_pval')]

write.csv(res, '/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_per_pT.csv', row.names=F, quote=F)
write.csv(res_best, '/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_best_pT.csv', row.names=F, quote=F)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_per_pT_CrossVal_UKBB.png', units='px', res=300, width=4500, height=3000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_per_pT_IndepVal_UKBB.png', units='px', res=300, width=4500, height=3000)
...
res<-list()
for(i in 1:8){
res_1<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/UKBB.w_hm3.',weight,'.',gwas[i],'.EUR-GeRSs.pred_comp.txt'), header=T, stringsAsFactors=F)
...
res_table$Cross_R_diff_perc<-res_table$Cross_R_diff/res_table$Model_1_Cross_R*100
res_table$Indep_R_diff_perc<-res_table$Indep_R_diff/res_table$Model_1_Indep_R*100

res_table$Phenotype<-gsub('\\..*','',rownames(res_table))
res_table<-res_table[,c('Phenotype',names(res_table)[-14])]
res_table[res_table$Test == 'GeRS_multi_tissue', ]
...
tmp_res$Cross_R_diff_pval<-format(tmp_res$Cross_R_diff_pval, scientific = TRUE, digits = 3)
tmp_res$Indep_R_diff_pval<-format(tmp_res$Indep_R_diff_pval, scientific = TRUE, digits = 3)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_tests_summary_CrossVal_UKBB.png', units='px', res=300, width=4500, height=4500)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_tests_summary_IndepVal_UKBB.png', units='px', res=300, width=4500, height=4500)
  plot_grid(Plot_1,Plot_2,Plot_3,Plot_4,Plot_5, labels = "AUTO", ncol=2)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_tests_summary_CrossVal_UKBB.png', units='px', res=300, width=4500, height=1500)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_tests_summary_IndepVal_UKBB.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO", ncol=2)
dev.off()
...
<details><summary>Plot comparison results (TissueSpecific)</summary>
```{R, echo=T, eval=F}
#####
# Compare results from each approach
#####
...
All_res_plot$Model[!All_res_plot$Model == 'All' & All_res_plot$Test == 'GeRS_multi_tissue']<-'GeRS TissueSpecific Best Tissue   '
All_res_plot$Model[All_res_plot$Model == 'All' & All_res_plot$Test == 'GeRS_multi_tissue']<-'GeRS TissueSpecific Multi Tissue'

All_res_plot$Model[!All_res_plot$Model == 'All' & All_res_plot$Test == 'PRS_and_GeRS']<-'PRS only   '
All_res_plot$Model[All_res_plot$Model == 'All' & All_res_plot$Test == 'PRS_and_GeRS']<-'PRS + GeRS TissueSpecific'

All_res_plot$Model<-factor(All_res_plot$Model, levels=c("GeRS TissueSpecific Best Tissue   ","GeRS TissueSpecific Multi Tissue","PRS only   ","PRS + GeRS TissueSpecific"))
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_UKBB.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO", ncol=2)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_UKBB.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO", ncol=2)
dev.off()
...
res_GWPRS<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/UKBB.w_hm3.',gwas[i],'.EUR-PRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/StratPRS_comp_CrossVal_UKBB.png', units='px', res=300, width=1500, height=1000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/StratPRS_comp_IndepVal_UKBB.png', units='px', res=300, width=1500, height=1000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_Tissue_comp_CrossVal_UKBB.png', units='px', res=300, width=3000, height=20000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_Tissue_comp_IndepVal_UKBB.png', units='px', res=300, width=3000, height=20000)
...
plot_list_CrossVal[[pheno[i]]]<-ggplot(tmp, aes(x=Model, y=CrossVal_R)) +
          geom_bar(stat="identity", position=position_dodge(0.9)) +
          geom_errorbar(aes(ymin=CrossVal_R-CrossVal_R_SE, ymax=CrossVal_R+CrossVal_R_SE), width=.2, position=position_dodge(0.9)) +
          labs(y="Correlation (SE)", x='', title=pheno[i]) +
          theme_half_open() +
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_Tissue_comp_CrossVal_UKBB.png', units='px', res=300, width=3000, height=20000)
  plot_grid(plotlist=plot_list_CrossVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_Tissue_comp_IndepVal_UKBB.png', units='px', res=300, width=3000, height=20000)
  plot_grid(plotlist=plot_list_IndepVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_UKBB.png', units='px', res=300, width=3000, height=20000)
  plot_grid(plotlist=plot_list_CrossVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_UKBB.png', units='px', res=300, width=3000, height=20000)
  plot_grid(plotlist=plot_list_IndepVal, ncol=1)
dev.off()
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_per_pT_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_per_pT_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
res$IndepVal_R<-paste0(res$IndepVal_R, " (", res$IndepVal_R_SE, ")")
res<-res[,c('Phenotype','Model','IndepVal_R','IndepVal_pval')]

names(res)<-c('Phenotype','Model',"R (SE)", "P")
...
res_GeRS$vg_est_clean<-paste0(round(res_GeRS$vg_est,3)," (",round(res_GeRS$vg_lowCI,3),"-",round(res_GeRS$vg_lowCI,3),")")
res_GeRS$pi0_est_clean<-paste0(round(res_GeRS$pi0_est,3)," (",round(res_GeRS$pi0_lowCI,3),"-",round(res_GeRS$pi0_lowCI,3),")")

res_PRS<-read.csv("/users/k1806347/brc_scratch/Analyses/PRS_comparison/UKBB_outcomes_for_prediction/PRS_AVENGME_res.csv")

res_PRS$vg_est_clean<-paste0(round(res_PRS$vg_est,3)," (",round(res_PRS$vg_lowCI,3),"-",round(res_PRS$vg_lowCI,3),")")
res_PRS$pi0_est_clean<-paste0(round(res_PRS$pi0_est,3)," (",round(res_PRS$pi0_lowCI,3),"-",round(res_PRS$pi0_lowCI,3),")")
...
res_diff<-res_diff[,c('Pheno_GeRSpe','GWAS','vg_est_clean_PRS','pi0_est_clean_PRS','vg_est_clean_GeRS','pi0_est_clean_GeRS','Prop_GE')]

library(knitr)
kable(res_diff, rownames = FALSE, caption='cis-regulated expression-based heritability in UK Biobank')
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_tests_summary_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_tests_summary_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
res$Cross_R_diff_perc<-paste0(round(res$Cross_R_diff_perc,1),'%')
res$Indep_R_diff_perc<-paste0(round(res$Indep_R_diff_perc,1),'%')
...
res<-res[,c("Phenotype","Test","Model_1","Model_2","Model_1_Cross_R","Model_2_Cross_R","Cross_R_diff",'Cross_R_diff_perc',"Cross_R_diff_pval","Model_1_Indep_R","Model_2_Indep_R","Indep_R_diff",'Indep_R_diff_perc',"Indep_R_diff_pval")]
names(res)<-c('Phenotype','Test',"Model 1","Model 2", 'Model 1 Cross R','Model 2 Cross R','Cross R diff','Cross R perc diff','Cross R diff pval','Model 1 Indep R','Model 2 Indep R','Indep R diff','Indep R perc diff','Indep R diff pval')
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_tests_summary_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_tests_summary_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
![Predictive utility estimated using 10-fold cross-validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_UKBB.png)

![Predictive utility estimated using test set validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_UKBB.png)
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/StratPRS_comp_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/StratPRS_comp_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
for(i in unique(res$Phenotype)){
  res_diff<-rbind(res_diff, data.frame(Phenotype=i,
                                       Prop_GE=res$IndepVal_R[res$Phenotype == i & res$Method == 'GeRS']/res$IndepVal_R[res$Phenotype == i & res$Method == 'PRS']))
}

res_diff[,2]<-round(res_diff[,2],3)

library(knitr)
kable(res_diff, rownames = FALSE, caption='Proportion of PRS explained by GeRS based on independent validation results')
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_Tissue_comp_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_Tissue_comp_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
![Predictive utility estimated using 10-fold cross-validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_UKBB.png)

![Predictive utility estimated using test set validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_UKBB.png)
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_Tissue_comp_CrossVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/UKBB_outcomes_for_prediction/GeRS_PP4_Tissue_comp_IndepVal_UKBB.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
res_best<-NULL
for(i in 1:4){
  res_i<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/TEDS.w_hm3.',weight,'.',gwas[i],'.EUR-GeRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
...
write.csv(res, '/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_per_pT.csv', row.names=F, quote=F)
write.csv(res_best, '/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_best_pT.csv', row.names=F, quote=F)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_per_pT_CrossVal_TEDS.png', units='px', res=300, width=4500, height=3000)
  plot_grid(plotlist=res_plot_CrossVal, ncol = 2)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_per_pT_IndepVal_TEDS.png', units='px', res=300, width=4500, height=3000)
  plot_grid(plotlist=res_plot_IndepVal, ncol = 2)
dev.off()
...
res<-list()
for(i in 1:4){
res_1<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withGeRSs/TEDS.w_hm3.',weight,'.',gwas[i],'.EUR-GeRSs.pred_comp.txt'), header=T, stringsAsFactors=F)
res_1<-res_1[res_1$Model_1 == 'All',]
res_1<-res_1[res_1$Model_2 != 'All',]
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_tests_summary_CrossVal_TEDS.png', units='px', res=300, width=4500, height=3000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_tests_summary_IndepVal_TEDS.png', units='px', res=300, width=4500, height=3000)
  plot_grid(Plot_1,Plot_2,Plot_3, Plot_4, Plot_5, labels = "AUTO")
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_tests_summary_CrossVal_TEDS.png', units='px', res=300, width=4500, height=1500)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_tests_summary_IndepVal_TEDS.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO")
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_TEDS.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO")
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_TEDS.png', units='px', res=300, width=4500, height=1500)
  plot_grid(Plot_2,Plot_3, labels = "AUTO")
dev.off()
...
res_GWPRS<-read.table(paste0('/users/k1806347/brc_scratch/Analyses/PRS_comparison/TEDS_outcomes_for_prediction/',pheno[i],'/Association_withPRSs/TEDS.w_hm3.',gwas[i],'.EUR-PRSs.pred_eval.txt'), header=T, stringsAsFactors=F)
res_GWPRS<-res_GWPRS[dim(res_GWPRS)[1],]
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/StratPRS_comp_CrossVal_TEDS.png', units='px', res=300, width=1500, height=1000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/StratPRS_comp_IndepVal_TEDS.png', units='px', res=300, width=1500, height=1000)
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_Tissue_comp_CrossVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_CrossVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_Tissue_comp_IndepVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_IndepVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_Tissue_comp_CrossVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_CrossVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_Tissue_comp_IndepVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_IndepVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_CrossVal, ncol=1)
dev.off()
...
png('/mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_TEDS.png', units='px', res=300, width=3000, height=10000)
  plot_grid(plotlist=plot_list_IndepVal, ncol=1)
dev.off()
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_per_pT_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_per_pT_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
res_PRS<-read.csv("/users/k1806347/brc_scratch/Analyses/PRS_comparison/TEDS_outcomes_for_prediction/PRS_AVENGME_res.csv")
...
library(knitr)
kable(res_diff, rownames = FALSE, caption='cis-regulated expression-based heritability in TEDS')
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_tests_summary_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_tests_summary_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_tests_summary_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_tests_summary_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
![Predictive utility estimated using 10-fold cross-validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_tests_summary_CrossVal_TEDS.png)

![Predictive utility estimated using test set validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_tests_summary_IndepVal_TEDS.png)
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/StratPRS_comp_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/StratPRS_comp_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_Tissue_comp_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_Tissue_comp_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_Tissue_comp_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_PP4_Tissue_comp_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
![Predictive utility estimated using 10-fold cross-validation](Images/Functionally_informed_prediction/GeRS_PP4_Tissue_comp_CrossVal_TEDS.png)

![Predictive utility estimated using test set validation](Images/Functionally_informed_prediction/GeRS_PP4_Tissue_comp_IndepVal_TEDS.png)
...
cp /mnt/lustre/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/

cp /scratch/users/k1806347/Analyses/GeRS_comparison/TEDS_outcomes_for_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_TEDS.png /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Images/Functionally_informed_prediction/
```
...
![Predictive utility estimated using 10-fold cross-validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_Tissue_comp_CrossVal_TEDS.png)

![Predictive utility estimated using test set validation](Images/Functionally_informed_prediction/GeRS_TissueSpecific_Tissue_comp_IndepVal_TEDS.png)
...
* I should try filtering genes based on coloc PP4 values (Done)
* I should try using tissue-specific eQTL effects - The Crohns paper do this by comparison to blood tissue data. I could do this by removing genes whos predicted expression is correlated with predicted expression of corresponding genes in the blood datasets.

Compare gain in R2 when including multiple tissue but use the same genes, so gains represent gain from tissue specificity rather than number of genes. Though SNP-weight sets with large sample will stll predict better due to higher R2 estimates.
