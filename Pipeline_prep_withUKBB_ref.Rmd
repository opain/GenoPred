...
# Create directory for the output
mkdir ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR

# Create list of gwas that PRScs scores should calculated for
> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo.txt
for gwas in $(echo DEPR06 COLL01 HEIG03 BODY03 DIAB05 COAD01 CROH01 SCLE02 RHEU01 EDUC03 ADHD04 BODY11);do
if [ ! -f ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/${gwas}/UKBB.noPheno.EUR.10K.w_hm3.${gwas}.EUR.scale ]; then
echo $gwas >> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo.txt
fi
done

# Run script for selected GWAS
for gwas in $(cat ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo.txt);do
...
> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N.txt
for gwas in $(echo DEPR06 COLL01 HEIG03 BODY03 DIAB05 COAD01 CROH01 SCLE02 RHEU01 EDUC03 ADHD04 BODY11);do
if [ ! -f ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/${gwas}_unmunged_impute_N/UKBB.noPheno.EUR.10K.w_hm3.${gwas}.EUR.scale ]; then
echo $gwas >> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N.txt
fi
done

# Run script for selected GWAS
for gwas in $(cat ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N.txt);do
sbatch -J SBayesR -n 8 --mem 50G -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/polygenic_score_file_creator_SBayesR/polygenic_score_file_creator_SBayesR.R \
--ref_plink ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.GW \
--ref_keep ${UKBB_output}/UKBB_ref/keep_files/UKBB_noPheno_EUR_10K.keep \
--ref_freq_chr ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.chr \
...
--memory 40000 \
--n_cores 8 \
--output ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/${gwas}_unmunged_impute_N/UKBB.noPheno.EUR.10K.w_hm3.${gwas} \
--ref_pop_scale ${UKBB_output}/UKBB_ref/keep_files/keep_file.list \
--munged F \
--impute_N T
n=$(($n+1))
...
> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N_P4.txt
for gwas in $(echo DEPR06 COLL01 HEIG03 BODY03 DIAB05 COAD01 CROH01 SCLE02 RHEU01 EDUC03 ADHD04 BODY11);do
if [ ! -f ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/${gwas}_unmunged_impute_N_P4/UKBB.noPheno.EUR.10K.w_hm3.${gwas}.EUR.scale ]; then
echo $gwas >> ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N_P4.txt
fi
done

# Run script for selected GWAS
for gwas in $(cat ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/todo_unmunged_impute_N_P4.txt);do
sbatch -J SBayesR -n 8 --mem 50G -p brc,shared /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/polygenic_score_file_creator_SBayesR/polygenic_score_file_creator_SBayesR.R \
--ref_plink ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.GW \
--ref_keep ${UKBB_output}/UKBB_ref/keep_files/UKBB_noPheno_EUR_10K.keep \
--ref_freq_chr ${UKBB_output}/UKBB_ref/genotype/UKBB.noPheno.EUR.10K.chr \
...
--memory 40000 \
--n_cores 8 \
--output ${UKBB_output}/UKBB_ref/Score_files_for_polygenic_SBayesR/${gwas}_unmunged_impute_N_P4/UKBB.noPheno.EUR.10K.w_hm3.${gwas} \
--ref_pop_scale ${UKBB_output}/UKBB_ref/keep_files/keep_file.list \
--munged F \
--impute_N T \
--P_max 0.4
...
# Create directory for the output
mkdir ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred

#######
# Run for best GWAS for target traits
#######

> ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred/todo.txt
for gwas in $(echo DEPR06 COLL01 HEIG03 BODY03 DIAB05 COAD01 CROH01 SCLE02 RHEU01 EDUC03 ADHD04 BODY11);do
if [ ! -f ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred/${gwas}/1KGPhase3.w_hm3.${gwas}.EUR.scale ]; then
echo $gwas >> ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred/todo.txt
fi
done

# Run script for selected GWAS
for gwas in $(cat ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred/todo.txt | tail -n +6);do
...
--n_cores 1 \
--ldpred ${ldpred} \
--output ${UKBB_output}/UKBB_ref/Score_files_for_poylygenic_LDPred/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${UKBB_output}/UKBB_ref/keep_files/keep_file.list
done
