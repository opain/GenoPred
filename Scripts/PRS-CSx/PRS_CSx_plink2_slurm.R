...
cat(
'#################################################################
# polygenic_score_file_creator_PRS-CSx.R V1.0
...
",opt$PRS_CSx_path," --meta=True --ref_dir=",opt$PRS_CSx_ref_path," --bim_prefix=",opt$ref_plink_chr,"${chr} --sst_file=",opt$output_dir,"/GWAS1_sumstats_temp.txt,",opt$output_dir,"/GWAS2_sumstats_temp.txt --pop=",opt$pop1,",",opt$pop2," --n_gwas=",round(GWAS1_N,0),",",round(GWAS2_N,0)," --out_dir=",opt$output_dir," --out_name=",opt$output_name," --chrom=${chr}

else

",opt$PRS_CSx_path," --meta=True --ref_dir=",opt$PRS_CSx_ref_path," --bim_prefix=",opt$ref_plink_chr,"${chr} --phi=${phi} --sst_file=",opt$output_dir,"/GWAS1_sumstats_temp.txt,",opt$output_dir,"/GWAS2_sumstats_temp.txt --pop=",opt$pop1,",",opt$pop2," --n_gwas=",round(GWAS1_N,0),",",round(GWAS2_N,0)," --out_dir=",opt$output_dir," --out_name=",opt$output_name," --chrom=${chr}
