...
for(file in 1:length(Files)){
  ...
  for(i in 1:length(pheno)){
    ...
    res_eval_i_select$Method<-factor(res_eval_i_select$Method, levels=c('pT+clump','lassosum','PRScs','SBLUP','SBayesR','LDpred1','LDpred2','DBSLMM','LDAK','All'))
  ...
  res_eval$Method<-factor(res_eval$Method, level=c("pT+clump",'lassosum','PRScs','SBLUP','SBayesR','LDpred1','LDpred2','DBSLMM','LDAK','All'))
  ...
  meta_res_eval$Method<-factor(meta_res_eval$Method, levels=c("pT+clump",'lassosum','PRScs','SBLUP','SBayesR','LDpred1','LDpred2','DBSLMM','LDAK','All'))
