...
Note. If this file is not provided, target sample analyses will not be performed.

***

## gwas_list

- name: Short name for the GWAS (do not include hyphens '-' in the name)
...
Note. This file should be space delimited.
Note. If this file is not provided, polygenic scoring will not be performed.
...
It is also possible to provide a list of external created score files (score_list) to be used for polygenic scoring. The score_list should have name, path and label columns, similar to the format of the gwas_list, except the path column should indicate the location of the score file. Caution: GenoPredPipe assumes the externally provided score files are restricted and harmonised to the HapMap3 SNP-list.
