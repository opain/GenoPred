...
# Plot intformational redundancy
...
## Estimate relative R2 and variance for masked PGS

We are evaluating PGS in UKB WGS data. We examine two approaches for masking, removing variants randomly, or based on their imputation quality in different UKB populations (INFO > 0.95). Estimate the relative R2 and variance of these masked scores, so we can compare these estimates to the observed values.
