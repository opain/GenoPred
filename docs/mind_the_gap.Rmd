...
write.table(gwas_list_nocor, '/users/k1806347/oliverpainfel/Analyses/mind_the_gap/GenoPred/config/gwas_list_mvp_dense.txt', col.names = T, row.names = F, quote = F)
...
config_dense<-c(
  ...
  "gwas_list: /users/k1806347/oliverpainfel/Analyses/mind_the_gap/GenoPred/config/gwas_list_mvp_dense.txt",
  "pgs_methods: ['sbayesrc','ptclump']",
  "cores_prep_pgs: 10",
  "dense_reference: T",
  "keep_ambiguous: T"
...
## Combine sqrtinfo scores into single file
...
## Combine rsq_90 scores into single file
...
### Calculate randomly masked MVP PGS
...
n_scores=$(sed -n "1p" /mnt/project/mind_the_gap/score_files/sparse/score_file_sparse.txt | awk "{print NF}")
export n_scores
...
## Generate PGS using UKB WGS GWAS with 1KG+HGDP reference
...
n_scores=$(zcat /mnt/project/mind_the_gap/score_files/sparse/score_file_wgs_sparse_sbayesrc_1kghgdp_ref.txt | sed -n "1p" | awk "{print NF}")
...
## Run GWAS using imputed UKB data
...
## Generate PGS models for imputed GWAS
...
### Combine UKB IMP scores into single file
...
### Calculate imp-based GWAS PGS in UKB
...
## Estimate relative R2 and var with random missingness
...
for(i in c(0.05, 0.25, 0.5)){
  ...
  write.table(
    rel_r2, 
    paste0(
      '~/oliverpainfel/Analyses/mind_the_gap/GenoPred/output_sbayesrc_dense/reference/pgs_score_files/est_rsq.wgs.dense.random.',i,'.txt'
    ), col.names = T, row.names = F, quote = F)
}
...
## Evaluate LD-naive estimation of relative variance
...
## Estimate relative R2 and var across arrays and panels
...
## Estimate relative r2 and variance after imputation
