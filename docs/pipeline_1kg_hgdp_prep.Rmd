...
This was an attempt of deriving a list of common variants from the full dbSNP data set. The common variant set from dbSNP works well though so this isn't needed. Keep just in case useful down the road.

## Denser list of common variants

The dbSNP list of common variants seemed to miss a lot of common variants, and have poor overlap with the HapMap3 SNPlist. To provide a higher level of coverage, download the full dbSNP data, and then identify variants with a MAF > 0.01 in at least 1 super population in 1KG+HGDP. 
...
# Subset CHR BP RSID A1 and A2 information
zgrep -v "^#" ~/oliverpainfel/Data/dbSNP/00-All.vcf.gz | awk '{print $1, $2, $3, $4, $5}' > ~/oliverpainfel/Data/dbSNP/00-All.vcf.mini
...
}' ~/oliverpainfel/Data/dbSNP/00-All.vcf.mini > ~/oliverpainfel/Data/dbSNP/00-All.vcf.mini.split
