...
png('/users/k1806347/oliverpainfel/Software/MyGit/GenoPred/docs/Images/UKB/cor_all.png', res=300, width=4000, height=8000, units = 'px')
ggplot(cor_subset, aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
...
ggplot(cor_subset[cor_subset$pop == 'EUR'], aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
    aes(ymin = r - se, ymax = r + se),
    width = .2,
    position = position_dodge(width = 0.7)
...
# Split plot for all populations into two parts
png('/users/k1806347/oliverpainfel/Software/MyGit/GenoPred/docs/Images/UKB/cor_all_part1.png', res=300, width=3500, height=4000, units = 'px')
ggplot(cor_subset[cor_subset$label %in% sort(unique(cor_subset$label))[1:7],], aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
    aes(ymin = r - se, ymax = r + se),
    width = .2,
    position = position_dodge(width = 0.7)
...
png('/users/k1806347/oliverpainfel/Software/MyGit/GenoPred/docs/Images/UKB/cor_all_part2.png', res=300, width=3500, height=4000, units = 'px')
ggplot(cor_subset[cor_subset$label %in% sort(unique(cor_subset$label))[-1:-7],], aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
    aes(ymin = r - se, ymax = r + se),
    width = .2,
...
png('/users/k1806347/oliverpainfel/Software/MyGit/GenoPred/docs/Images/UKB/cor_all_small.png', res=300, width=3500, height=4000, units = 'px')
ggplot(cor_subset[cor_subset$pheno %in% con_phenos ,], aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
    aes(ymin = r - se, ymax = r + se),
    width = .2,
    position = position_dodge(width = 0.7)
...
ggplot(cor_subset[cor_subset$pheno %in% bin_phenos ,], aes(x = Method, y = r, fill = model)) +
  geom_errorbar(
    aes(ymin = r - se, ymax = r + se),
    width = .2,
    position = position_dodge(width = 0.7)
...
<details><summary>Show associations for all populations</summary>

<div class="centered-container">
<div class="rounded-image-container">
![UK Biobank - All populations](Images/UKB/cor_all.png)
</div>
</div>
...
<div class="centered-container">
<div class="rounded-image-container">
![UK Biobank - All populations](Images/UKB/cor_eur.png)
</div>
</div>
