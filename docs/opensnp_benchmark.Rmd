...
snakemake --profile slurm --use-conda --configfile=misc/opensnp/config.yaml outlier_detection -n 
```
...
write.csv(bm_dat_height, 'Images/OpenSNP/time_cpu_bench_pgs_methods_prscsx.csv', row.names=F, quote=F)
...
<details><summary>Show PRS-CSx benchmark</summary>
