...
for pheno in $(tail -n +6 /users/k1806347/oliverpainfel/Data/ukb/phenotypes/prscsx/prscsx_labels.txt); do
...
```{bash}
snakemake --profile slurm --use-conda --configfile=/users/k1806347/oliverpainfel/Data/ukb/GenoPred/configs/crosspop/config_all.yaml target_pgs -n
```
...
```{bash}
snakemake --profile slurm --use-conda --configfile=/users/k1806347/oliverpainfel/Data/ukb/GenoPred/configs/crosspop/config.yaml output_all -n
```
