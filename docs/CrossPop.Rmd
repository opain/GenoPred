...
- LDpred2
  - AFR: [downoad link](https://drive.google.com/file/d/1Fc3v_N1m-ocGqw6E4HpzEVq43jS2oWUQ/view?usp=sharing)
...
- SBayesRC
  - AFR: [download link](https://drive.google.com/file/d/1osaNy_EyFAoIQd2ZNOoRJbZsr9Vwr9NP/view?usp=sharing)
  - EAS: [download link](https://drive.google.com/file/d/1eUtC9JEodJf2tnDFbU-xabO_UwL2JutF/view?usp=sharing)
  - EUR: [download link](https://drive.google.com/file/d/1O05z8nQhPqATuhfQvhJq7LEuxS0bzlXm/view?usp=sharing)
...
tiff('~/oliverpainfel/Analyses/crosspop/plots/average_r.perc_improv.tiff', width = 3200, height = 2000, res= 300, units = 'px')
ggplot(meta_tmp_simple[meta_tmp_simple$Target != 'EUR Target',], aes(x=label, y=R_diff_perc , fill = Model1)) +
#    geom_boxplot(
#      data = tmp_simple[tmp_simple$Target != 'EUR Target',],
#        mapping = aes(x=label, y=R_diff_perc, colour=Model1),
...
tiff('~/oliverpainfel/Analyses/crosspop/plots/leopard_perc_improv.tiff', width = 1800, height = 1100, res= 300, units = 'px')
...
tiff('~/oliverpainfel/Analyses/crosspop/sensitivity_mvp/plots/average_r.perc_improv.tiff', width = 3200, height = 1500, res= 300, units = 'px')
ggplot(meta_tmp_simple[meta_tmp_simple$Target != 'EUR Target',], aes(x=label, y=R_diff_perc , fill = Model1)) +
#    geom_boxplot(
#      data = tmp_simple[tmp_simple$Target != 'EUR Target',],
#        mapping = aes(x=label, y=R_diff_perc, colour=Model1),
...
We will use two approaches to compare the ancestry within the GWAS and LD reference samples:
1. Project reference genetic principal components into the GWAS samples
2. Estimate ancestral proportions within GWAS and LD reference samples using bigsnpr
...
p1 <- ggplot(pc_all, aes(x = PC1, y = PC2)) +
  geom_point(data = pc_all[pc_all$type == 'Reference',], aes(fill = Population), size = 5, shape = 21) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], colour = 'black', size = 3, shape = 3, stroke = 2.5) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], aes(colour = GWAS), size = 4, shape = 3, stroke = 1.5) +
  theme_half_open() +
  background_grid() +
  ggtitle("PC1 vs PC2") +
  guides(
    colour = guide_legend(title = "GWAS", nrow = 2),
    fill = guide_legend(title = "Population", nrow = 2)
  )

p2 <- ggplot(pc_all, aes(x = PC3, y = PC4)) +
  geom_point(data = pc_all[pc_all$type == 'Reference',], aes(fill = Population), size = 5, shape = 21) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], colour = 'black', size = 3, shape = 3, stroke = 2.5) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], aes(colour = GWAS), size = 4, shape = 3, stroke = 1.5) +
  theme_half_open() +
...
p3 <- ggplot(pc_all, aes(x = PC5, y = PC6)) +
  geom_point(data = pc_all[pc_all$type == 'Reference',], aes(fill = Population), size = 5, shape = 21) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], colour = 'black', size = 3, shape = 3, stroke = 2.5) +
  geom_point(data = pc_all[pc_all$type == 'GWAS',], aes(colour = GWAS), size = 4, shape = 3, stroke = 1.5) +
  theme_half_open() +
...
png('~/oliverpainfel/Analyses/crosspop/plots/genetic_distance.png', units = 'px', width = 4000, height = 1500, res = 300)
