...
#  "pgs_methods: ['ptclump','dbslmm','prscsx','xwing','tlprs','prscs','lassosum','ldpred2','megaprs','quickprs','sbayesrc']",
  "pgs_methods: ['ptclump','quickprs','quickprs_multi','dbslmm','lassosum','megaprs','sbayesrc']",
...
for(pheno_i in selected_traits){
  ...
  res_i$Source<-ifelse(res_i$Method %in% c(pgs_group_methods, 'all') | !grepl('EUR|EAS|AFR', res_i$Group), 'Multi', 'Single')
