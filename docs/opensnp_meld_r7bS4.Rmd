...
- LDpred2 refdirs: `/users/k1806347/oliverpainfel/Data/hgdp_1kg/ldpred2/meld/<label>/{LD_with_blocks_chr*.rds, map.rds}` (moved out of the repo — private-refdir symlinks under `pipeline/misc/opensnp/private_ldpred2_ldref_<label>/AMR` point at this Data location)
