...
We have made docker and singularity containers with GenoPred pre-installed. These can be useful when running the pipeline in an offline environment (see [here](#running-in-offline-environment)), or on a computer that does not have a linux operating system. This is how to download the containers using either docker or singularity.
...
# Singularity
singularity pull --arch amd64 library://opain/genopred/genopred_pipeline:v0.2
```
