...
snakemake -n --configfile=example_input/config_example.yaml output_all

# Run the pipeline running one step at a time 
snakemake -j1 --configfile=example_input/config_example.yaml --use-conda output_all
...
```{bash}
snakemake -j1 --use-conda --configfile=example_input/config_example.yaml output_all
```
