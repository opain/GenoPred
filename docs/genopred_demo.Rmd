...
Now, go into the `pipeline` folder within the GenoPred repo, and create the conda environment based on the `envs/base.yaml` file. This will create an environment called `genopred` with some essential packages installed.
