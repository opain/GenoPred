...
# Create directory
mkdir ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld

# Create file listing GWAS that haven't been processed.
> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/todo.txt
for i in $(seq 1 16);do
gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
if [ ! -f ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/${gwas_i}/1KGPhase3.w_hm3.${gwas_i}.EUR.scale ]; then
echo ${gwas_i} >> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/todo.txt
fi
done

# Create shell script to run using sbatch
cat > ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/sbatch.sh << 'EOF'
#!/bin/sh
...
#SBATCH -n 5
#SBATCH --nodes 1
#SBATCH -J LDAK_highld

. /users/k1806347/brc_scratch/Software/MyGit/GenoPred/config_used/Pipeline_prep.config

gwas=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/todo.txt)

echo ${gwas}

/users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/ldak_mega_prs/ldak_mega_prs_highld.R \
--ref_plink ${Geno_1KG_dir}/1KGPhase3.w_hm3.GW \
--ref_keep ${Geno_1KG_dir}/keep_files/EUR_samples.keep \
--sumstats ${gwas_rep_qcd}/${gwas}.cleaned.gz \
--plink1 ${plink1_9} \
...
--memory 5000 \
--n_cores 5 \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list

EOF

sbatch --array 1-$(wc -l ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/todo.txt | cut -d' ' -f1)%3 ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_highld/sbatch.sh
...
# Create directory
mkdir ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2

# Create file listing GWAS that haven't been processed.
> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/todo.txt
for i in $(seq 1 16);do
gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
if [ ! -f ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/${gwas_i}/1KGPhase3.w_hm3.${gwas_i}.EUR.scale ]; then
echo ${gwas_i} >> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/todo.txt
fi
done

# Create shell script to run using sbatch
cat > ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/sbatch.sh << 'EOF'
#!/bin/sh
...
gwas=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/todo.txt)
...
--memory 5000 \
--n_cores 5 \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list

EOF

sbatch --array 1-$(wc -l ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/todo.txt | cut -d' ' -f1)%3 ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/sbatch.sh

####################################

# Run again for DEPR06 to check random seed impact on pseudo results
. /users/k1806347/brc_scratch/Software/MyGit/GenoPred/config_used/Pipeline_prep.config

sbatch -p shared,brc --mem 20G -n 5 --nodes 1 -J LDAK_5.2 /users/k1806347/brc_scratch/Software/Rscript.sh /users/k1806347/brc_scratch/Software/MyGit/GenoPred/Scripts/ldak_mega_prs/ldak_mega_prs_5.2.R \
--ref_plink ${Geno_1KG_dir}/1KGPhase3.w_hm3.GW \
--ref_keep ${Geno_1KG_dir}/keep_files/EUR_samples.keep \
--sumstats ${gwas_rep_qcd}/DEPR06.cleaned.gz \
--plink1 ${plink1_9} \
--plink2 ${plink2} \
--ldak /users/k1806347/brc_scratch/Software/ldak5.2.linux \
--ldak_map /users/k1806347/brc_scratch/Data/LDAK/genetic_map_b37 \
...
--memory 5000 \
--n_cores 5 \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2/DEPR06_rep/1KGPhase3.w_hm3.DEPR06 \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list


##############
# Run again specifying --genomic-control YES when running --sum-her
##############
...
# Create directory
mkdir ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon

# Create file listing GWAS that haven't been processed.
> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/todo.txt
for i in $(seq 1 16);do
gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
if [ ! -f ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/${gwas_i}/1KGPhase3.w_hm3.${gwas_i}.EUR.scale ]; then
echo ${gwas_i} >> ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/todo.txt
fi
done

# Create shell script to run using sbatch
cat > ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/sbatch.sh << 'EOF'
#!/bin/sh
...
gwas=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/todo.txt)
...
--all_models T \
--genomic_control T \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list

EOF

sbatch --array 1-$(wc -l ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/todo.txt | cut -d' ' -f1)%3 ${Geno_1KG_dir}/Score_files_for_polygenic/LDAK_5.2_gencon/sbatch.sh
...
<details><summary>Show code</summary>
```{bash, eval=F, echo=T}
# Download and decompress required reference data
mkdir -p /users/k1806347/brc_scratch/Data/LDAK/quick_prs
cd /users/k1806347/brc_scratch/Data/LDAK/quick_prs
wget https://genetics.ghpc.au.dk/doug/gbr.hapmap.tar.gz
tar -xzvf gbr.hapmap.tar.gz
rm gbr.hapmap.tar.gz
...
# Create directory
mkdir ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS

# Create file listing GWAS that haven't been processed.
> ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/todo.txt
for i in $(seq 1 16);do
gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
if [ ! -f ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/${gwas_i}/1KGPhase3.w_hm3.${gwas_i}.EUR.scale ]; then
echo ${gwas_i} >> ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/todo.txt
fi
done

# Create shell script to run using sbatch
cat > ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/sbatch.sh << 'EOF'
#!/bin/sh
...
gwas=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/todo.txt)
...
--memory 5000 \
--n_cores 5 \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list

EOF

sbatch --array 1-$(wc -l ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/todo.txt | cut -d' ' -f1)%3 ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS/sbatch.sh

####################
# Run again specifying genomic control
####################
...
# Create directory
mkdir ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon

# Create file listing GWAS that haven't been processed.
> ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/todo.txt
for i in $(seq 1 16);do
gwas_i=$(echo ${gwas} | cut -f ${i} -d ' ')
if [ ! -f ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/${gwas_i}/1KGPhase3.w_hm3.${gwas_i}.EUR.scale ]; then
echo ${gwas_i} >> ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/todo.txt
fi
done

# Create shell script to run using sbatch
cat > ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/sbatch.sh << 'EOF'
#!/bin/sh
...
gwas=$(awk -v var="$SLURM_ARRAY_TASK_ID" 'NR == var {print $1}' ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/todo.txt)
...
--genomic_control T \
--n_cores 5 \
--output ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/${gwas}/1KGPhase3.w_hm3.${gwas} \
--ref_pop_scale ${Geno_1KG_dir}/super_pop_keep.list

EOF

sbatch --array 1-$(wc -l ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/todo.txt | cut -d' ' -f1)%3 ${Geno_1KG_dir}/Score_files_for_polygenic/QuickPRS_gencon/sbatch.sh
